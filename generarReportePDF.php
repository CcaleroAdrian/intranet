...
$fecha1 = strftime('%d de %B',$date1);//date("d-F-Y", $date1);
$fecha2 = strftime('%d de %B',$date2);//date("d-F-Y",$date2);
...
$pdf->Ln(0.5);
$pdf->Cell(5,1,"",0,'L');
$pdf->Cell(6,1,utf8_decode($usuario),0,'R','C');
...
//$pdf->Cell(3,1,'',1);
$pdf->Cell(0.5,1,'','T');
$pdf->Cell(6.8,1,"Firma y nombre de quien autoriza",'T');
...
$pdf->Output('I','Documento soporte('.$fechaDescarga.').pdf');//cerramos el documento
?>