<?php
	...
	$usr = isset($_POST['EMAIL']) ? trim( strtolower($_POST['EMAIL']) ) : "" ;
		...
		try{
			$.ajax({
				...
				success: function(data) {
				    $.get('procesa_IniciarSesion.php', { USR : data['email_1'], ID : data['empleado_id'], AREA : data['area_id'],PERFIL:data['perfil_id']});
				    //console.log(data);
				...
				error: function(jqXHR,estado){
					//console.log(estado);
					window.location.href="intranet.itw.mx?ERROR=Usuario o contraseña incorrecta, favor de verificar credenciales.";
				}
			});	
...
<style type="text/css">
	#body{
		background-image: url('../intraImg/logoITWfinal.jpg');
		width: 100%;
		height: 70%;
...
<body>
	<div id="body"></div>
	<div id="spinner" style="margin-left:50%; margin-top:60%;"></div>
</body>
